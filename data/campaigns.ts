...
export const CAMPAIGN_LEVELS: CampaignLevel[] = [
  ...
  },
  {
    ...
    difficulty: 'EASY',
    enemyArmy: { [UnitType.SOLDIER]: 25, [UnitType.SNIPER]: 5 },
  ...
  },
  {
    ...
    difficulty: 'MEDIUM',
    enemyArmy: { [UnitType.SOLDIER]: 50, [UnitType.MORTAR]: 5 },
  ...
  },
  {
    ...
    difficulty: 'MEDIUM',
    enemyArmy: { [UnitType.LIGHT_TANK]: 5, [UnitType.SOLDIER]: 80 },
  ...
  },
  {
    ...
    difficulty: 'HARD',
    enemyArmy: { [UnitType.LIGHT_TANK]: 15, [UnitType.SNIPER]: 25, [UnitType.HELICOPTER]: 1 },
  ...
  // --- TIER 2: MECHANIZED WARFARE ---
  {
    ...
    difficulty: 'HARD',
    enemyArmy: { [UnitType.HELICOPTER]: 5, [UnitType.SOLDIER]: 200, [UnitType.MORTAR]: 15 },
  ...
  },
  {
    ...
    difficulty: 'HARD',
    enemyArmy: { [UnitType.TANK]: 10, [UnitType.LIGHT_TANK]: 30 },
  ...
  },
  {
    ...
    difficulty: 'EXTREME',
    enemyArmy: { [UnitType.HELICOPTER]: 15, [UnitType.FIGHTER_JET]: 5, [UnitType.PATROL_BOAT]: 10 },
  ...
  },
  {
    ...
    difficulty: 'EXTREME',
    enemyArmy: { [UnitType.TANK]: 25, [UnitType.HOWITZER]: 10, [UnitType.COMMANDO]: 20 },
  ...
  },
  {
    ...
    difficulty: 'EXTREME',
    enemyArmy: { [UnitType.HEAVY_TANK]: 5, [UnitType.TANK]: 40, [UnitType.MLRS]: 10 },
  ...
  // --- TIER 3: HEAVY ASSAULT ---
  {
    ...
    difficulty: 'EXTREME',
    enemyArmy: { [UnitType.MLRS]: 30, [UnitType.SOLDIER]: 1000, [UnitType.SNIPER]: 200 },
  ...
  },
  {
    ...
    difficulty: 'EXTREME',
    enemyArmy: { [UnitType.HEAVY_TANK]: 20, [UnitType.COMMANDO]: 100, [UnitType.HELICOPTER]: 25 },
  ...
  },
  {
    ...
    difficulty: 'EXTREME',
    enemyArmy: { [UnitType.BOMBER]: 10, [UnitType.FIGHTER_JET]: 40, [UnitType.MLRS]: 25 },
  ...
  },
  {
    ...
    difficulty: 'EXTREME',
    enemyArmy: { [UnitType.DESTROYER]: 20, [UnitType.PATROL_BOAT]: 80, [UnitType.FIGHTER_JET]: 25 },
  ...
  },
  {
    ...
    difficulty: 'EXTREME',
    enemyArmy: { [UnitType.SUBMARINE]: 30, [UnitType.HELICOPTER]: 60, [UnitType.DESTROYER]: 15 },
  ...
  // --- TIER 4: WORLD WAR ---
  {
    ...
    enemyArmy: { [UnitType.HEAVY_TANK]: 60, [UnitType.TANK]: 150, [UnitType.HOWITZER]: 50 },
  ...
  },
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.BOMBER]: 30, [UnitType.FIGHTER_JET]: 100, [UnitType.MLRS]: 60 },
  ...
  },
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.DESTROYER]: 60, [UnitType.SUBMARINE]: 60, [UnitType.PATROL_BOAT]: 200 },
  ...
  },
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.MLRS]: 150, [UnitType.HOWITZER]: 150, [UnitType.COMMANDO]: 800, [UnitType.SNIPER]: 1000 },
  ...
  },
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.HEAVY_TANK]: 150, [UnitType.BOMBER]: 80, [UnitType.HELICOPTER]: 250 },
  ...
  // --- TIER 5: ENDGAME ---
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.BOMBER]: 120, [UnitType.HEAVY_TANK]: 200, [UnitType.MLRS]: 120 },
  ...
  },
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.DESTROYER]: 200, [UnitType.BOMBER]: 150, [UnitType.SUBMARINE]: 120 },
  ...
  },
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.HEAVY_TANK]: 400, [UnitType.MLRS]: 400, [UnitType.COMMANDO]: 1500 },
  ...
  },
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.BOMBER]: 300, [UnitType.FIGHTER_JET]: 600, [UnitType.HELICOPTER]: 600, [UnitType.MLRS]: 300 },
  ...
  },
  {
    ...
    difficulty: 'NIGHTMARE',
    enemyArmy: { [UnitType.HEAVY_TANK]: 800, [UnitType.BOMBER]: 500, [UnitType.DESTROYER]: 300, [UnitType.SUBMARINE]: 300 },
