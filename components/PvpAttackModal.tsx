        ...
        <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center sm:p-4 bg-black/90 backdrop-blur-xl animate-[fadeIn_0.2s_ease-out]">
            <div 
                className={`
                    ...
                    rounded-t-2xl md:rounded-xl max-h-[90vh] md:max-h-[90vh]
                    ${isWarTarget ? 'border-red-500/30' : 'border-yellow-500/30'}
                `}
            >
                {/* All Content - Scrollable */}
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                    <div className={`p-4 border-b border-white/10 flex justify-between items-center ${isWarTarget ? 'bg-red-950/20' : 'bg-yellow-950/20'}`}>
                        <div>
                    ...
                    <div className="p-4 bg-black/30 flex flex-col gap-3 border-b border-white/5">
