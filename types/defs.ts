...
export interface TranslationDictionary {
  common: {
    ...
    ui: {
      ...
      garrison_title: string;
      garrison_total: string;
      garrison_power: string;
      garrison_composition: string;
      garrison_empty: string;
      garrison_more: string;
      allied_reinforcements: string;
      allied_reinforcements_available: string;
      allied_reinforcements_none: string;
      allied_reinforcements_hint: string;
      allied_bot_reputation: string;
      allied_eta: string;
      allied_units: string;
      allied_more: string;
      allied_unit_count: string;
      blue_team: string;
      red_team: string;
      draw: string;
      time_base: string;
      ...
      diplomacy_stats: string;
      diplomacy_stats_desc: string;
      tooltip_avg_rep: string;
      tooltip_allies: string;
      tooltip_allies_desc: string;
      tooltip_enemies: string;
      tooltip_enemies_desc: string;
      tooltip_score_desc: string;
      bot_event: string;
      tooltip_event_desc: string;
      tooltip_cooldown: string;
      tooltip_cost: string;
      tooltip_insufficient_resources: string;
      reputation: string;
      tooltip_gift_cooldown: string;
      tooltip_reputation_low: string;
      tooltip_alliance_req: string;
      current: string;
      tooltip_requirement: string;
      tooltip_alliance_cooldown: string;
      tooltip_peace_unnecessary: string;
      tooltip_peace_desc: string;
      tooltip_peace_cooldown: string;
      tooltip_peace_bonus: string;
      ...
      reputation_history: string;
      reputation_trend: string;
      reputation_improving: string;
      reputation_worsening: string;
      reputation_stable: string;
      reputation_total_interactions: string;
      reputation_gifts_sent: string;
      reputation_alliances_proposed: string;
      reputation_peace_proposed: string;
      reputation_attacks_won: string;
      reputation_attacks_lost: string;
      reputation_defends_won: string;
      reputation_defends_lost: string;
      reputation_last_interaction: string;
      reputation_relationship_status: string;
      reputation_category: string;
      reputation_decay_status: string;
      reputation_no_decay: string;
      reputation_normal_decay: string;
      reputation_accelerated_decay: string;
      reputation_personality_warlord_gift: string;
      reputation_personality_turtle_gift: string;
      reputation_personality_tycoon_gift: string;
      reputation_personality_rogue_gift: string;
      gift_codes: string;
